...
void Fbx::Draw(Transform& transform, int frame, float Diffuse, XMFLOAT4 Ambient,XMFLOAT4 Speculer, float Brightness, float scroll, Direct3D::SHADER_TYPE shaderType)
{
